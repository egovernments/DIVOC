...
export const AppointmentConfirm = (props) => {
    ...
    return (
        <CustomConfirmPage onDone={() => {history.push("/registration")}}>
            ...
            <span style={{fontSize: "18px", marginBottom: "1rem"}}>On the day of vaccination, please carry your original {getNameOfTheId(getNationalIdType(state.identity))} for verification</span>
        </CustomConfirmPage>
    )
};
