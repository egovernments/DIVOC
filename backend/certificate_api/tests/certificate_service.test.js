...
test('should return latest certificate based on updated time if grouping param is not available', () => {
    const expectedLatestCertificate = {
        name: 'John Doe updated',
        contact: [ 'tel:9691742639' ],
        mobile: '9691742639',
    ...
    const actualLatestCertificate = certificate_service.getLatestCertificateV2(certificates);
    expect(expectedLatestCertificate).toEqual(actualLatestCertificate);
});

test('should return latest dose\'s latest certificate when grouping parameter is dose', () => {
    const expectedLatestCertificate = {
        name: 'John Doe',
        contact: [ 'tel:9691742639' ],
        mobile: '9691742639',
    ...
    const actualLatestCertificate = certificate_service.getLatestCertificateV2(certificates, "dose");
    expect(expectedLatestCertificate).toEqual(actualLatestCertificate);
});
