...
let signingConfig = {
  ...
  COMMUNICATION_MODE_KAFKA : config.COMMUNICATION_MODE_KAFKA,
  COMMUNICATION_MODE_RABBITMQ : config.COMMUNICATION_MODE_RABBITMQ,
  COMMUNICATION_MODE_RESTAPI : config.COMMUNICATION_MODE_RESTAPI,
