...
const DefaultQueueSuffix = "_reg"

func InitializeRabbitmq() {

	StartEnrollmentTopicProducerOnChannel(CreateNewConnectionAndChannel())
	StartAppointmentAckTopicProducerOnChannel(CreateNewConnectionAndChannel())
	StartNotifyTopicProducerOnChannel(CreateNewConnectionAndChannel())
	StartEnrollmentACKTopicProducerOnChannel(CreateNewConnectionAndChannel())
}
...
func StartAppointmentAckTopicProducerOnChannel(c *amqp.Connection, ch *amqp.Channel) {
	go func() {
...
func StartEnrollmentACKTopicProducerOnChannel(c *amqp.Connection, ch *amqp.Channel) {
	go func() {
