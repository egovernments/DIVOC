...
type GetRecipientsHandlerFunc func(GetRecipientsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetRecipientsHandlerFunc) Handle(params GetRecipientsParams) middleware.Responder {
	return fn(params)
}

// GetRecipientsHandler interface for that can handle valid get recipients params
type GetRecipientsHandler interface {
	Handle(GetRecipientsParams) middleware.Responder
}
