...
func (o *GetConfigurationURL) Build() (*url.URL, error) {
	...
	var _path = "/v1/divoc/configuration"
	...
	var lastKnownVersionQ string
	if o.LastKnownVersion != nil {
		lastKnownVersionQ = *o.LastKnownVersion
	}
	if lastKnownVersionQ != "" {
		qs.Set("lastKnownVersion", lastKnownVersionQ)
	}
