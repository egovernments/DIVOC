...
// PostEnrollmentsParams contains all the bound params for the post enrollments operation
// typically these are obtained from a http.Request
//
// swagger:parameters PostEnrollments
...
//
// To ensure default values, the struct must have been initialized with NewPostEnrollmentsParams() beforehand.
func (o *PostEnrollmentsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
