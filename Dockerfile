...
WORKDIR /app
ENV PATH /app/node_modules/.bin:$PATH
ENV REACT_APP_ETCD_URL $ETCD_URL
ENV REACT_APP_CONFIGURATION_LAYER $CONFIGURATION_LAYER
ENV REACT_APP_ETCD_AUTH_ENABLED $ETCD_AUTH_ENABLED
ENV REACT_APP_ETCD_USERNAME $ETCD_USERNAME
ENV REACT_APP_ETCD_PASSWORD $ETCD_PASSWORD
